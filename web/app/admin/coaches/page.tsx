    ...
    <div className="min-h-screen bg-gray-950 text-white px-6 py-10">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex items-center gap-4">
          <Link href="/admin" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-1">
          ...
          <h1 className="text-xl font-bold text-white">Coach Management</h1>
          <button
        ...
        {error && (
          <div className="bg-red-500/10 border border-red-500/30 rounded-xl px-4 py-3 text-sm text-red-300">
            {error}
            <button onClick={fetchCoaches} className="ml-3 underline hover:no-underline">Retry</button>
          </div>
        )}
