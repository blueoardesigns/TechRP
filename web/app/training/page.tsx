...
const NO_STAGE_DIRECTIONS = '[VOICE OUTPUT RULES] You are speaking out loud on a phone call. NEVER output stage directions, action descriptions, or narration in asterisks, parentheses, or brackets (e.g., do NOT say "*smiling slightly*", "(pauses to think)", "[checks calendar]"). If you would normally pause to do something, SAY it naturally instead — "let me check my calendar real quick… one second…" or "hmm, give me a moment to think about that." Only output words that should be spoken aloud.\n\n';

const DIFFICULTY_MODIFIERS: Record<'easy' | 'medium' | 'hard', string> = {
  easy: NO_STAGE_DIRECTIONS + '[DIFFICULTY: EASY] Start the call guarded and mildly reluctant — you are busy, skeptical, or simply not expecting the call. Do NOT immediately engage or show willingness. After the rep demonstrates genuine value, empathy, or rapport (usually 1–2 minutes), gradually warm up. Raise one minor objection before agreeing. You should feel like a real person who was interrupted, not someone waiting for a sales pitch.\n\n',
  medium: NO_STAGE_DIRECTIONS + '[DIFFICULTY: MEDIUM] Start the call reluctant and uninterested — you have other priorities and did not ask for this conversation. Brush off the first attempt to engage with a stall like "I\'m actually pretty busy" or "We already have someone for that." Require the rep to earn your attention through value or curiosity before you engage. Raise 1–2 solid objections. Only agree if the rep genuinely addresses your concerns.\n\n',
  hard: NO_STAGE_DIRECTIONS + '[DIFFICULTY: HARD] Start the call hostile or dismissive — you actively do not want to talk. Hit the rep with an immediate stall or objection like "Not interested" or "We\'re all set, thanks." If they persist, raise 2–3 strong objections and push back firmly. You will only continue the conversation if the rep says something genuinely surprising, valuable, or catches your curiosity. Do not commit easily — even if warmed up, require a compelling close.\n\n',
};
